...
public class MainStageTest {
    ...
    void new_show_is_contained_in_list_of_all_shows() {
        Show newShow = new Show(ANY_TITLE, ANY_TIME, ANY_PRICE);
        stage.add(newShow);
    ...
    void list_all_shows_fetches_updates_from_repository() {
        Show show = new Show(ANY_TITLE, ANY_TIME, ANY_PRICE);
    ...
    void too_expensive_shows_are_filtered_out() {
        Show anyShow = new Show(ANY_TITLE, ANY_TIME, ANY_PRICE);
        Show cheapShow = new Show(ANY_TITLE, ANY_TIME, 2);
        Show expensiveShow = new Show(ANY_TITLE, ANY_TIME, 200);
